...
test_url="http://127.0.0.1:${port}/wheels/testbox?db=${db}&format=json&only=failure,error&method=runRemote&directory=&testBundles=wheels%2Etests_testbox%2Especs%2Econtroller%2Ecsrf%2Ecookie&opt_run=true&coverageEnabled=false"
